...
# HOW TO CHANGE LATER:
#  - To rebalance column widths, edit the ratios in st.columns([...]).
#  - Keep every visual box inside its own `with colX.container(border=True, height="stretch")`.
#    This makes all 3 siblings stretch to the tallest one.
# =========================================================
